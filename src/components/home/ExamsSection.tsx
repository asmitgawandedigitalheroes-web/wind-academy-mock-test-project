    ...
    <section className="py-24 bg-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <h2 className="text-sm font-black text-primary uppercase tracking-[0.3em]">Available Examinations</h2>
          <h3 className="text-4xl md:text-5xl font-black text-[#0f172a] leading-tight">
            Exams Currently <span className="text-primary italic">Supported</span> by Wings Academy
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {exams.map((exam, idx) => (
            <div 
              key={idx} 
              className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-primary/5 group hover:border-primary/20 hover:scale-[1.01] transition-all flex flex-col sm:flex-row gap-8 items-center sm:items-start text-center sm:text-left"
            >
              <div className="w-20 h-20 bg-primary/5 rounded-[2rem] flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:text-white transition-all group-hover:rotate-6 shadow-inner">
              ...
              <div className="space-y-4 flex-1">
                ...
                <div>
                  <h4 className="text-xl font-black text-[#0f172a]">{exam.title}</h4>
                ...
                <Link 
                  href="/login" 
                  className="inline-flex items-center gap-2 text-primary text-sm font-black group/link"
                >
                  Explore Course
        ...
        <div className="mt-16 text-center">
            <p className="text-sm font-bold text-slate-400 italic">
                Don't see your exam? <Link href="/contact" className="text-primary underline decoration-primary/30 underline-offset-4 hover:decoration-primary">Request a subject</Link> and we'll prioritize it.
            </p>
        </div>
      </div>
    </section>
